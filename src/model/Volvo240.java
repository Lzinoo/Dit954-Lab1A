...
public class Volvo240 extends Cars {
    ...
    /**
     *  A Volvo 240 object is a subtype of model.Cars - has 4 doors, is the color Black, 100 in engine power,
    ...
    public Volvo240(int x_pos, int y_pos){
        super(4, new Engine(100), Color.black, "model.Volvo240", x_pos, y_pos);
        stopEngine();
    }
     ...
     */
    public Volvo240() {
        super(4,new Engine(100), Color.black, "model.Volvo240", 0, 0);
        stopEngine();
    }

    /** Altered method for model.Volvo240 for use in methods incrementSpeed
