...
public class Transport extends Trucks {
    ...
    /**
     * A model.Transport object is a subtype of cars that has 2 doors, an enginePower of 90.
     * The platform is up by default. The model.Transport object can load and transport other
     * objects of type cars except for type model.Transport.
     *
     ...
     * A model.Transport object is a subtype of cars that has 2 doors, an enginePower of 90.
     * The platform is up by default. The model.Transport object can load and transport other
     * objects of type cars except for type model.Transport. Without any parameters the
    ...
    /**
     * A method that sets the platform to the down position. Only works if the model.Transport
     * has a speed of 0.
     */
    @Override
    ...
    /** model.Transport object specific angle - is either 0 degrees or 70.
     ...
     * an object of the subclass model.Transport.
     * Then based on the direction of the model.Transport checks that the car is behind and not too far on either side
     * of the transport to allow it to be loaded on.
     * @param carInput Any vehicle of class model.Cars, except model.Transport, that will be loaded on to the model.Transport vehicle
     */
    ...
    /**
     * Removes the last added car from the model.Transport and returns that as a new car.
    ...
    /**
     * Updates the positions of the loaded cars to the match the model.Transport
     */
