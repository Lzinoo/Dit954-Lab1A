...
public class Scania extends Trucks {
    ...
    /**
     * A model.Scania object is a subtype of model.Cars - Has 2 doors, is the color White, has 90 engine power
    ...
    public Scania(int x_pos, int y_pos) {
        super(2, new Engine(90), Color.white, "model.Scania", x_pos, y_pos);
        platformAngle = 0;
        stopEngine();
    }
     ...
     */
    public Scania() {
        super(2, new Engine(90), Color.white, "model.Scania", 0,0);
        platformAngle = 0;
        stopEngine();
    }
    ...
    /**
     * First checks if the model.Scania is moving and if so it will set the angle of the platform to 0
