 ...
 * @param <T> The type of model.Vehicles allowed in the workshop. Superclass <i>model.Vehicles</i> for all subtypes.
 */
public class Workshop <T extends Vehicles>{
    ...
    /** A model.Workshop object. Allows storage of model.Cars - or a specific subtype of model.Cars.
