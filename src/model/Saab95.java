...
public class Saab95 extends Cars {
    ...
    /**
     * A Saab 95 object is a subtype of model.Cars - has 2 doors, is the color Red, 125 in engine power,
    ...
    public Saab95(int x_pos, int y_pos){
        super(2,new Engine(125),Color.red,"model.Saab95", x_pos, y_pos);
        turboOn = false;
        stopEngine();
    }
     ...
     */
    public Saab95() {
        super(2, new Engine(125), Color.red,"model.Saab95", 0, 0);
        turboOn = false;
        stopEngine();
    }
    ...
    /** Altered method for model.Saab95 for use in methods incrementSpeed
